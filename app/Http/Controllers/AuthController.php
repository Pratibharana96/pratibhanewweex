...
class AuthController extends Controller
{
    ...
    public function login(Request $request){
        ...
        if(Auth::attempt(['email' => request('email'), 'password' => request('password')])){
            ...
            return redirect('register')->with('info', 'You are not registered with us please First Register');
        }
    }
   ...
   //dd($value);exit;
    //dd($data['password']);exit;
        ...
        File::makeDirectory(public_path().'/storage/documents/'.'client_id-'.$username, 0755, true);
